...
<div class="cwr-redeem-wallet" style="margin-bottom: 20px; padding: 10px; border: 1px solid #ddd; border-radius: 5px;">
    ...
    <p><?php printf(esc_html__('You have %s in your wallet (Max $30 redeemable per order).', 'cwr'), wc_price($wallet_balance)); ?></p>
    <p>
        <label for="cwr_redeem_amount"><?php esc_html_e('How Much You Want To Redeem (Max $30 redeemable per order):', 'cwr'); ?></label>
        <input type="number" id="cwr_redeem_amount" name="cwr_redeem_amount" min="0" step="0.01" value="<?php echo esc_attr($session_redeem_amount); ?>">
    </p>
...
jQuery(document).ready(function($) {
    ...
    // Initial validation and update on page load
